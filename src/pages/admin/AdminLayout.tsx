...
import { LayoutDashboard, Package, Grid3X3, Image, LogOut, ArrowLeft, ShoppingCart, Settings, Menu, X, MessageSquare, Send, FileText } from "lucide-react";
...
const navItems = [
  ...
  { to: "/admin/reviews", icon: Package, label: "Reviews" },
